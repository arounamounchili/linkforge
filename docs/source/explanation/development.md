...
1. Update the `DEP_CONFIG` dictionary in `platforms/blender/scripts/build.py`.
2. Run `uv run python platforms/blender/scripts/build.py sync` to download wheels for all supported platforms.
