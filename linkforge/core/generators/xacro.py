...
class XACROGenerator(URDFGenerator):
    ...
    def _generate_macro_definition(
        ...
        if template_joint.limits:
            ...
            if template_joint.limits.lower is not None and template_joint.limits.upper is not None:
                if template_joint.limits.lower != 0.0 or template_joint.limits.upper != 0.0:
