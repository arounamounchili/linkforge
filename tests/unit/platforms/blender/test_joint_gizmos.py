...
def test_generate_axis_geometry(scene) -> None:
...
def test_fix_existing_joints(scene) -> None:
...
def test_update_viz_handle_switching(mocker, scene) -> None:
...
def test_draw_internal(mocker, scene) -> None:
...
def test_fix_current_scene(mocker, scene) -> None:
...
def test_shader_fallback(mocker, scene) -> None:
...
def test_draw_internal_no_objects(mocker, scene) -> None:
...
def test_draw_internal_disabled(mocker, scene) -> None:
...
def test_unregister(mocker, scene) -> None:
...
def test_draw_joint_axes(mocker, scene) -> None:
...
def test_draw_internal_no_region_data(mocker, scene) -> None:
...
def test_fix_existing_joints_exception(mocker, scene) -> None:
