...
def test_filter_dict_empty_search_returns_all(scene) -> None:
...
def test_filter_list_empty_search_returns_all(scene) -> None:
...
def test_filter_dict_case_sensitivity_uppercase(scene) -> None:
...
def test_filter_dict_case_sensitivity_lowercase(scene) -> None:
...
def test_filter_dict_case_sensitivity_mixed(scene) -> None:
...
def test_filter_list_case_sensitivity_uppercase(scene) -> None:
...
def test_filter_list_case_sensitivity_lowercase(scene) -> None:
...
def test_filter_dict_substring_match(scene) -> None:
...
def test_filter_list_substring_match(scene) -> None:
...
def test_filter_dict_exact_match(scene) -> None:
...
def test_filter_list_exact_match(scene) -> None:
...
def test_filter_dict_no_matches(scene) -> None:
...
def test_filter_list_no_matches(scene) -> None:
...
def test_filter_empty_dict(scene) -> None:
...
def test_filter_empty_list(scene) -> None:
...
def test_filter_none_search_term_dict(scene) -> None:
...
def test_filter_none_search_term_list(scene) -> None:
...
def test_filter_whitespace_only_search(scene) -> None:
...
def test_filter_leading_trailing_whitespace(scene) -> None:
...
def test_filter_special_chars(scene) -> None:
...
def test_filter_trailing_spaces_in_search_query(scene) -> None:
...
def test_filter_very_long_search_query(scene) -> None:
...
def test_filter_list_objects_missing_name_attr(scene) -> None:
...
def test_dict_input_returns_dict_type(scene) -> None:
...
def test_list_input_returns_list_type(scene) -> None:
