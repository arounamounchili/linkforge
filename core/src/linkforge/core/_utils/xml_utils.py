...
def get_xml_header(element: ET.Element, version: str | None = None) -> str:
    """Standardized header comment for XML files.

    Args:
        element: Root XML element (to extract robot name)
        version: Optional LinkForge version
...
<!--
  ...
  Generated by: LinkForge{version_str}
...
def serialize_xml(
    ...
    Args:
        ...
        version: Optional LinkForge version for header
