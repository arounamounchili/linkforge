...
class LINKFORGE_OT_import_robot_model(Operator, ImportHelper):  # type: ignore[misc]
    ...
    def execute(self, context: Context) -> OperatorReturn:
        ...
        """
        from linkforge_core import URDFParser, clear_xacro_cache
        ...
        from linkforge_core import find_sandbox_root
        ...
        from linkforge_core import FileSystemResolver, RobotParserError, XacroDetectedError
        ...
        try:
            ...
            if is_xacro:
                ...
                from linkforge_core import XacroResolver
